                        ...
                        while($row = mysqli_fetch_assoc($result))
                        {
                           echo "
                             <tr>
                                ...
                                <td>$row[amenities]</td>
                                <td>
                                    <a href='see_more.php?id=$row[hotel_id]'><i class='fa-solid fa-circle-info'></i></a>
                                    <a href='delete.php?id=$row[hotel_id]' class='delete'><i class='fa-solid fa-trash-can'></i></a>
                                </td>
                            </tr>
                           ";
                        }
